...
// Gateway RPC response types (subset used by the Hermes client).
// Source of truth: Hermes AgentSummarySchema / sessions.list / agents.list
...
export type HermesThreadListItem = {
  id: string;
  title: string;
  createdAt: number;
