...
export function MobileCronsView({
  ...
  return (
    <div className="hermes-fade-in flex h-full flex-1 overflow-hidden bg-background">
      {sorted.length === 0 ? (
        <div
...
function MobileCronDetailOverlay({
  ...
  return (
    <div className="hermes-fade-in fixed inset-0 z-[70] flex flex-col bg-background dark:bg-foreground">
      <MobileDetailHeader
        onBack={onClose}
