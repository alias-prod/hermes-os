...
function MobileNavSheet({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex">
      <div
        className="hermes-slide-in-left flex h-full w-[min(80vw,280px)] flex-col bg-background"
        style={{
      ...
      >
        <header className="sticky top-0 z-10 flex items-center justify-between bg-background px-ml py-m">
          <h2 className="font-heading text-lg font-bold">
            <span className="text-text-neutral-primary">Hermes</span>
      ...
      <button
        ...
        className="hermes-fade-in flex-1 bg-overlay"
      />
    </div>
  );
}
