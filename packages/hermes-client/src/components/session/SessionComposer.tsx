 ...
 * client-side) and Hermes's gateway commands (which get intercepted by the
...
export function SessionComposer({
  ...
  useEffect(() => {
    ...
    window.addEventListener("hermes-os:prime-composer", listener as EventListener);
    return () => window.removeEventListener("hermes-os:prime-composer", listener as EventListener);
  }, []);
  ...
  return (
    <div
      className={`hermes-os-session-composer relative mb-1 w-full rounded-xl border border-border-default/25 bg-foreground p-[2px] sm:mb-3 dark:border-border-default/8 ${
                  ...
                  {rotation.tokens.map((token, i) =>
                    token.wordIndex < 0 ? (
                      ...
                      <span
                        ...
                        className="hermes-word-blur-in inline-block"
                        style={{
                ...
                {rotation.streamDone ? (
                  ...
                  <span className="flex h-5 shrink-0 items-center">
                    <Tag
                      ...
                      size="md"
                      variant="neutral"
                      className="hermes-fade-in opacity-70"
                    >
                      TAB
                    </Tag>
                  </span>
          ...
          {onModelChange
            ? (() => {
                ...
                const defaultModel = hint
                  ...
                  : null;
                // hermes's `models.list` can repeat the same qualified id (e.g.
